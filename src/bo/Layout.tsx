...
import { CATEGORY_PAGE, HOME_PAGE, ORDER_PAGE, PRODUCT_PAGE, SALE_PAGE, SETTING_PAGE } from "../settings/constant";
            ...
            items: [
                {
                    ...
                    icon: 'pi pi-fw pi-list',
                    command:() => {navigate(CATEGORY_PAGE)}
                },
                {
